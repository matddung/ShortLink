...
export const options = {
  scenarios: {
    select_only_redirect_miss_traffic: {
...
export default function () {
  const response = http.get(`${BASE_URL}/s-select/${MISSING_SHORT_CODE}`, {
    redirects: 0,
    tags: { endpoint: 'redirect-select-only-miss', traffic: 'missing-shortcode' },
  });
